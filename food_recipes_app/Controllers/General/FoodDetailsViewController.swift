...
class FoodDetailsViewController: UIViewController {
    ...
    let favouriteButton: UIButton = {
        let button = UIButton()
        let icon = UIImage(named: "heart")?.withTintColor(.red)
    ...
    func setupUI(){
        ...
        foodImageView.addSubview(favouriteButton)
        favouriteButton.centerXAnchor.constraint(equalTo: foodImageView.centerXAnchor, constant: -10).isActive = true
        favouriteButton.centerYAnchor.constraint(equalTo: foodImageView.centerYAnchor, constant: 10).isActive = true
...
//            favouriteButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            favouriteButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant:-35),
            favouriteButton.topAnchor.constraint(equalTo: view.topAnchor, constant: 240),
    ...
    @objc func addToFavoriteList() {
            ...
            else
            {
                ...
                API.addToFavorite(userId: unwrappedUserId, foodId: unwrappedFoodId) { result in
                    switch result {
                    case .success:
    ...
    public func configure(with model: FoodsDetailsViewModels) {
        foodID = model.foodId
